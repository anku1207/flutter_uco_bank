...
class TimeSlotDialog extends StatefulWidget {
  ...
  TimeSlotDialog(this.customCallFunction({String? timeSlot}), {Key? key, required this.itemlist}) : super(key: key);
                          ...
                          Expanded(
                              child: ListView.builder(
                                ...
                                itemBuilder: (context, index) {
                                  String selectTimeSlot = widget.itemlist[index];
                                  return InkWell(
                                      onTap: () {
                                        widget.customCallFunction(timeSlot:selectTimeSlot );
